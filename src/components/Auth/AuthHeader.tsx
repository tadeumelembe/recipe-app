...
const AuthHeader: React.FC<IHeader> = ({ title }) => {
    ...
    return (
        <Animated.View testID={'animated-view'} style={[authStyles.header, { height: headerHeight }]}>
            <ImageBackground testID="background-image" imageStyle={{ borderBottomRightRadius: 80 }} source={require('../../../assets/images/login-header.png')}>
